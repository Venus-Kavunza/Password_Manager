...
class Credential:
	...
	def find_by_site_name(cls, site_name):
		'''
		This method takes in a site_name and returns a credential that matches that site_name.
		'''
		for credential in cls.credentials_list:
	...
	def copy_credential(cls,site_name):
		'''
		This class method copies a credential's info after the credential's site name is entered
		'''
