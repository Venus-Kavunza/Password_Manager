...
class TestCredentials(unittest.TestCase):
	...
	def test__init__(self):
		...
		'''
		self.assertEqual(self.new_credential.user_name,'Venus')
		self.assertEqual(self.new_credential.site_name,'Facebook')
		self.assertEqual(self.new_credential.account_name,'Vee')
		self.assertEqual(self.new_credential.password,'dwsp003')
	...
	def test_save_credentials(self):
		...
		twitter = Credential('Venus','Twitter','Vee','dwsd003')
	...
	def test_copy_credential(self):
		...
		self.assertEqual('dwsp003',pyperclip.paste())
